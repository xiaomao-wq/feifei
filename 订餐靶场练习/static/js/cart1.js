$(document).ready(function () {
    ...
    $(".allselect").click(function () {
        $(".gwc_tb2 input[name=cartList[]]").each(function () {
    ...
    // 所有复选(:checkbox)框点击事件
    $(".gwc_tb2 input[name=cartList[]]").click(function () {
        if ($(this).attr("checked")) {
...
$(function () {
    ...
    function setTotal() {
        $(".tot").html((parseInt(t.val()) * 100).toFixed(2));
        $("#newslist-2").val(parseInt(t.val()) * 100);
    }
    setTotal();
})
$(function () {
    ...
    function setTotal() {
        ...
        $(".tot").html((parseInt(t.val()) * 100).toFixed(2));
        $("#newslist-1").val(parseInt(t.val()) * 100);
    }
    setTotal();
})
//<!--总数-->
